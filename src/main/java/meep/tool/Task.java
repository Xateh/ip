...
/**
 * Abstract base for tasks with Todo, Deadline and Event variants. Provides parsing helpers,
...
public abstract class Task {
  ...
  /**
   * Serializes a task to a pipe-delimited save string. Example: |T|0|desc|, |D|1|desc|2025-01-01|,
  ...
  /**
   * Parses a user command into a Task. Returns a Pair where either the task or the exception is
   * non-null.
   *
   * @param task raw command (e.g., "todo ...", "deadline ... /by yyyy-MM-dd", "event ... /from ...
   *     /to ...")
  ...
  /**
   * Formats a date string for display using the output format, returning the original input if
   * parsing fails.
   *
   * @param time date string
