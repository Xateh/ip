...
class EventTask extends Task {
    ...
    EventTask(String task, String eventStartTime, String eventEndTime, boolean isDone) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid date format. Please use: " + Task.getInputDtfPattern());
        }
    ...
    public String toString() {
        return "[E]" + super.toString()
            + " (from: " + Task.printTime(getEventStartTime())
            + " to: " + Task.printTime(getEventEndTime())
            + ")";
    }
}
