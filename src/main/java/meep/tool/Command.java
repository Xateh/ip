 ...
 * in-memory message and task lists and print responses via {@link meep.ui.Ui}.
 */
class Command {
	 ...
	 *
	 * @param message
	 *            full command string starting with "check due "
	 ...
	 * matching tasks in a numbered list. Matching is case-sensitive. If there are
	 * no matches, prints a suitable message.
	 *
	 * @param string
	 *            substring to search for within task descriptions
	 */
